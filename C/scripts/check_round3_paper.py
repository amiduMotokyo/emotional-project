...
from C.scripts.export_round3_paper import SOURCE, ROOT
import win32com.client

def main():
    assets=SOURCE.parent/'assets/round3'
    ...
    try:
        ...
        captions=[p.Range.Information(3) for p in d.Paragraphs if re.match('图C3-[0-9] ',p.Range.Text)]
        tables=[]
        ...
        preview=ROOT/'C/outputs/q2_round3_paper_preview';preview.mkdir(exist_ok=True)
